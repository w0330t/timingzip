...
LastEditTime: 2022-08-22 15:40:01
LastEditors: Blueness
Description: 为pz做的一个自动把存档每隔多少分钟打包保存到另外一个文件夹里的玩意
FilePath: /undefined/home/w0330t/文档/Projects/timingzip/main.py
'''
import zipfile, os, time, pendulum

from loguru import logger


out_zip_name = pendulum.now().format('YYYY-MM-DD HH:mm:ss') + '.zip'
